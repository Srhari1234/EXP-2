...
size of short int: 2byte
size of long int: 4byte
size of long int: 4byte
size of unsigned char: 1byte
size of signed char: 1byte
size of unsigned int: 4byte
size of signed int: 4byte
size of unsigned long int: 4byte
size of signed long int: 4byte
size of unsigned short int: 2byte
size of signed short int: 2byte
size of unsigned long long int: 8byte
size of bool: 1byte 
